var ImageSearchManager = require('./image-search-manager');
...
module.exports = (function(){
  ...
  Doge.prototype.showImage = function(count){
    var that = this;
    if(!count) count = 0;
  ...
  Doge.prototype.output = function(res){
  ...
  Doge.prototype.showBranding = function(res){
    // console.log(res);
  ...
  Doge.prototype.getTransform = function(obj){
